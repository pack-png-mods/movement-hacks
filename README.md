# movement-hacks
Adds flying and sprinting to Alpha 1.2.2a
...
1. Download movement-hacks from the [releases page](https://github.com/pack-png-mods/movement-hacks/releases).
...
1. Clone the repository
   ```
   git clone https://github.com/pack-png-mods/movement-hacks
   cd movement-hacks
   ```
...
1. [Create a pull request](https://help.github.com/en/articles/creating-a-pull-request)
   so that your changes can be integrated into movement-hacks
